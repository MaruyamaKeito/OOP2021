...
namespace AddressBook
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: このコード行はデータを 'infosys202115DataSet.Person' テーブルに読み込みます。必要に応じて移動、または削除をしてください。
            this.personTableAdapter.Fill(this.infosys202115DataSet.Person);
        ...
        {
            this.personTableAdapter.FillByName(this.infosys202115DataSet.Person,tbNameSearch.Text);
        }
        ...
        {
            this.personTableAdapter.FillByBirthday(this.infosys202115DataSet.Person, dateTimePicker1.Text);
        }
    }
}
